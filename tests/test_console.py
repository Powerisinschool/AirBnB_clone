...
class TestConsole(unittest.TestCase):
    def test_help(self):
        ...
        self.assertEqual('Prints the repr of an \
instance e.g `$ show BaseModel 1234-1234-1234`\n', f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("help create")
        self.assertEqual('Creates a new instance and prints \
...
#         self.assertEqual(f.getvalue(), '\n')
    ...
    def test_basedotall(self):
        ...
        self.assertIn(x.getvalue().strip('\n'), f.getvalue())
